...
<div class="d-flex align-items-center justify-content-center h-100">
  ...
  <div class="d-flex h-100 justify-content-center align-items-center col-lg-7 bg-gradient-light text-dark">
    <div class="card card-outline card-warning w-75">
      <div class="card-header text-center"><br><br><br><br><br><br><br><br>
        ...
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <textarea name="address" id="address" rows="2" class="form-control form-control-sm rounded-0" placeholder="Enter your Address here..."></textarea>
            </div>
          </div>
